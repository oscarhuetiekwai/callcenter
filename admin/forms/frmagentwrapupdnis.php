...
<script language="JavaScript">
	...
	function nowGenerateReports(id, id2)
	{
		...
		*/
		//open in new tab
        window.open(baseURI + '/birt-viewer-2_6_1/frameset?__report=reports/report_agentwrapup_DNIS.rptdesign&startdate=' + dtReport + '&endate=' + dtReport2 + '&tenantid=' + nTenantID);
