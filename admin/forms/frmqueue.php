...
<script language="JavaScript">
	...
	function nowGenerateReports(id, id2)
	{
		...
		$('.btn_generate').openDOMWindow({ 
									...
									positionLeft:285, 
									windowSource:'iframe', 
									windowSourceURL: baseURI + '/birt-viewer/frameset?__report=queue.rptdesign&dtReport=' + dtReport + '&dtReport2=' + dtReport2,
									windowPadding:0, 
									loader:1,
									borderSize:0, 
		...
		*/
		//open in new tab
        window.open(baseURI + '/birt-viewer/frameset?__report=queue.rptdesign&dtReport=' + dtReport + '&dtReport2=' + dtReport2);
