...
function createChatBox(chatboxtitle,minimizeChatBox) {
	if ($("#chatbox_"+chatboxtitle).length > 0) {
        ...
        //body.innerHTML += "<div id = 'chatbox_" + chatboxtitle + "' class='chatbox'> <div class='chatboxhead'><div class='chatboxtitle'>"+chatboxtitle+"</div><div class='chatboxoptions'><a href='javascript:void(0)' onclick='javascript:toggleChatBoxGrowth(\""+chatboxtitle+"\")'>-</a> <a href='javascript:void(0)' onclick='javascript:closeChatBox(\""+chatboxtitle+"\")'>X</a></div><br clear='all'/></div><div class='chatboxcontent'></div><div class='chatboxinput'><textarea class='chatboxtextarea' onkeydown='javascript:return checkChatBoxInputKey(event,this,\""+chatboxtitle+"\");'></textarea></div> </div>";
        
	$("<div />" ).attr({id: "chatbox_"+chatboxtitle, name: "chatbox"})
	.addClass("chatbox")
