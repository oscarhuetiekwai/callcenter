...
/*			height: screen.availHeight - 125 - 202,
			width: screen.availWidth - 253,
			positionType: 'absolute',
			positionTop: 202,
			//eventType:'click', 
			positionLeft: 252,
			windowSource: 'iframe',
			windowSourceURL: baseURI + '/birt-viewer/frameset?__report=queue_summary.rptdesign&dtReport=' + dtReport + '&dtReport2=' + dtReport2,
			windowPadding: 0,
			loader: 1,
			borderSize: 0,
			...
			//draggable:1, 
			windowSource: 'iframe',
			windowSourceURL: baseURI + '/birt-viewer-2_6_1/frameset?__report=reports/queue_summary.rptdesign&tenantid=' + nTenantID + '&dtstart=' + dtReport + '&dtend=' + dtReport2,
			loader:1, 
			loaderImagePath:'images/preloader.png', 
...
<div id="divparameters">
	<table style="vertical-align:middle;">
		<tr><td colspan="2"><b>Queue Summary Report</b>&nbsp;&nbsp;&nbsp;</td><td></td></tr>
        <tr><td>&nbsp;&nbsp;&nbsp;</td>
        	<td>Date Range:
...
<div id="virtualqueuereport">
	<div class="col1">
		<div class="formfields">
			<div style="vertical-align:middle;">Date Range:
				<input type="text" name="report_date" id="report_date" class="formtext" 
                	onclick="return generateEnabled('btn_report_date');" readonly />          
                <div>
                	<button name="btn_report_date" id="btn_report_date" class="btn_generate" 
                    	onclick="return generateReportDate('report_date');">Generate</button>
