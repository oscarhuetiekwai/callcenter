...
/*			height: screen.availHeight - 125 - 202,
			...
			//draggable:1,
			windowSource: 'iframe',
			windowSourceURL: baseURI + '/birt-viewer-2_6_1/frameset?__report=reports/agent_performance_monthly.rptdesign&tenantid=' + nTenantID + '&startdate=' + dtReport + '&enddate=' + dtReport2,
			loader:1,
			loaderImagePath:'images/preloader.png',
...
<div id="divparameters">
	<table style="vertical-align:middle;">
		<tr><td colspan="2"><b>Agent Performance Monthly Report</b>&nbsp;&nbsp;&nbsp;</td><td></td></tr>
        <tr><td>&nbsp;&nbsp;&nbsp;</td>
        	<td>Date Range:
