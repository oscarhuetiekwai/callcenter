...
<script language="JavaScript">
	...
	function generateReportDate(id)
	{
		...
		$('.btn_generate').openDOMWindow({  
			...
			//draggable:1, 
			windowSource: 'iframe',
			windowSourceURL: baseURI + '/birt-viewer-2_6_1/frameset?__report=reports/queue_summary_hourly.rptdesign&tenantid=' + nTenantID + '&dtreport=' + startdate,
			loader:1, 
		...
		*/
		//open in new tab
        window.open(baseURI + '/birt-viewer-2_6_1/frameset?__report=reports/queue_summary_hourly.rptdesign&tenantid=' + nTenantID + '&dtreport=' + startdate);
...
<div id="divparameters">
	<table style="vertical-align:middle;">
		<tr><td colspan="2"><b>Queue Hourly Report</b>&nbsp;&nbsp;&nbsp;</td><td></td></tr>
        <tr><td>&nbsp;&nbsp;&nbsp;</td>
        	<td>Report Date::
