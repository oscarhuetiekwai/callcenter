...
<script language="JavaScript">
	...
	function nowGenerateReports(id, id2)
	{
		...
		*/
		//open in new tab
        window.open(baseURI + '/birt-viewer-2_6_1/frameset?__report=reports/agent_performance_monthly.rptdesign&tenantid=' + nTenantID + '&startdate=' + dtReport + '&enddate=' + dtReport2);
