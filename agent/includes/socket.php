...
class ClientSocket {
	...
	public function connect() {
		...
		if ( isset($this->m_Socket) ) {
			try {
                                socket_set_option($this->m_Socket, SOL_SOCKET, SO_RCVTIMEO, array("sec"=>5, "usec"=>500));
                                socket_set_option($this->m_Socket, SOL_SOCKET, SO_SNDTIMEO, array("sec"=>5, "usec"=>500));
