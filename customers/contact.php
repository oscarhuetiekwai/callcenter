...
record_set('insertlimit',"SELECT count(*) as maxlimit FROM contacts ");
...
{
	echo '<script> alert("Can not add new contact.")</script>';
}
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td colspan="2">Email <br />
            <!--<input name="contact_email" type="text" class="required validate-email" id="contact_email" value="<?php echo $row_contact['contact_email']; ?>" size="35" />-->
				<input name="contact_email" type="text"  id="contact_email" value="<?php echo $row_contact['contact_email']; ?>" size="35" />
